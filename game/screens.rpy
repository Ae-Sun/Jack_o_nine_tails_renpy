...
style slave_screen_order_button_text:
    ...
    size 16
    hover_color "#ffff00"
style slave_screen_order_button2 is default
style slave_screen_order_button2_text:
    color "#D80000"
    font "fonts/Segoe Print.ttf"
    size 16
    hover_color "#FF0000"
...
screen about():
    ...
    use game_menu(_("C & D"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Thanks to {color=#FFD700}Crushboss{/color} and the defunct HF community for developing the game up to the version 1.7.5.\nThanks to {color=#FFD700}Fugitive Red{/color}, for the version 1.8, which we used as the base for 2.0.\n")
